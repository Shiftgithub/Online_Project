...
<div class="col-md-10">
<a href="mailto:serbermz2020@gmail.com" style="color:#000000">mamunmiaturan@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Mamun Mia Turan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Mamun Mia Turan</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01965572363</h4>
		<h4 style="font-family:'typo' ">mamunmiaturan@gmail.com</h4>
		<h4 style="font-family:'typo' ">Sonargaon University</h4></div></div>
		</p>
      </div>
